...
import github.mgrlyz.mgsoddities.api.IAlloyInteraction;
...
public class ItemAlloy extends Item {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (player != null && MekanismConfig.general.transmitterAlloyUpgrade.get()) {
            ...
            IAlloyInteraction alloyInteraction = (IAlloyInteraction) WorldUtils.getCapability(world, Capabilities.ALLOY_INTERACTION, pos, context.getClickedFace());
