...
public enum MGsOdditiesConfigTranslations implements IConfigTranslation {
    ...
    GENERAL_CARDBOARD_MOD_BLACKLIST("general.cardboard.mod_blacklist", "Cardboard Box Mod Blacklist",
            "Any modids added to this list will not be able to have any of their blocks, picked up by the cardboard box. For example: [\"" + MGsOddities.MODID + "\"]",
            "Edit Blacklist"),
    ...
    PE_MAPPER_CHEMICAL_CHEMICAL_TO_CHEMICAL("projecte.mapper.chemical_chemical_to_chemical", MGsOddities.MOD_NAME + " CC2C",
            "Maps Mekanism chemical infuser and pigment mixer recipes.", true),
    PE_MAPPER_CRYSTALLIZER("projecte.mapper.chemical_crystallizer", MGsOddities.MOD_NAME + " Crystallizer", "Maps Mekanism crystallizing recipes.", true),
    PE_MAPPER_DISSOLUTION("projecte.mapper.chemical_dissolution", MGsOddities.MOD_NAME + " Dissolution", "Maps Mekanism dissolution recipes.", true),
    PE_MAPPER_CHEMICAL_TO_CHEMICAL("projecte.mapper.chemical_to_chemical", MGsOddities.MOD_NAME + " C2C",
            "Maps Mekanism activating and centrifuging recipes.", true),
    PE_MAPPER_COMBINER("projecte.mapper.combiner", MGsOddities.MOD_NAME + " Combiner", "Maps Mekanism combiner recipes.", true),
    PE_MAPPER_ELECTROLYSIS("projecte.mapper.electrolysis", MGsOddities.MOD_NAME + " Electrolysis", "Maps Mekanism electrolytic separator recipes.", true),
    PE_MAPPER_WASHING("projecte.mapper.todo", MGsOddities.MOD_NAME + " Washing", "Maps Mekanism washing recipes.", true),
    PE_MAPPER_EVAPORATING("projecte.mapper.evaporating", MGsOddities.MOD_NAME + " Evaporating", "Maps Mekanism evaporating recipes.", true),
    PE_MAPPER_ITEM_CHEMICAL_TO_ITEM("projecte.mapper.item_chemical_to_item", MGsOddities.MOD_NAME + " IC2I",
    ...
    PE_MAPPER_ITEM_TO_CHEMICAL("projecte.mapper.item_to_chemical", MGsOddities.MOD_NAME + " I2C",
            "Maps Mekanism item stack to chemical recipes. (Chemical conversion, Oxidizing, Pigment Extracting)", true),
    PE_MAPPER_ITEM_TO_ITEM("projecte.mapper.item_to_item", MGsOddities.MOD_NAME + " Item To Item",
            "Maps Mekanism Machine recipes that go from item to item. (Crushing, Enriching, Smelting)", true),
    PE_MAPPER_PRESSURIZED_REACTION("projecte.mapper.pressurized_reaction", MGsOddities.MOD_NAME + " PRC", "Maps Mekanism pressurized reaction recipes. (Disabled by default)", true),
    PE_MAPPER_ROTARY("projecte.mapper.rotary", MGsOddities.MOD_NAME + " Rotary", "Maps Mekanism rotary condensentrator recipes.", true),
    PE_MAPPER_SAWING("projecte.mapper.sawing", MGsOddities.MOD_NAME + " Sawing",
    ...
    public record TierTranslations(@Nullable IConfigTranslation first, @Nullable IConfigTranslation second, @Nullable IConfigTranslation third) {
        ...
        private static String getKey(String type, String tier, String path) {
            return Util.makeDescriptionId("configuration", MGsOddities.rl("tier." + type + "." + tier + "." + path));
        }
        ...
        public static MGsOdditiesConfigTranslations.TierTranslations create(TransporterTier tier) {
        ...
        public static MGsOdditiesConfigTranslations.TierTranslations create(ConductorTier tier) {
    ...
    public record OreConfigTranslations(IConfigTranslation topLevel, IConfigTranslation shouldGenerate) {
        ...
        private static String getKey(String ore, String path) {
            return Util.makeDescriptionId("configuration", MGsOddities.rl("world." + ore + "." + path));
        }
    ...
    public record OreVeinConfigTranslations(
        ...
        private static String getKey(String ore, String vein, String path) {
            return Util.makeDescriptionId("configuration", MGsOddities.rl("world." + ore + "." + vein + "." + path));
        }
