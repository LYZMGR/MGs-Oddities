...
public interface IConfigTranslation extends IHasTranslationKey {
    ...
    record ConfigTranslation(String getTranslationKey, String title, String tooltip, @Nullable String button) implements mekanism.common.config.IConfigTranslation {
