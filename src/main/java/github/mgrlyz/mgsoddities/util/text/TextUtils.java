...
public final class TextUtils {
    ...
    public static Component getPercent(double ratio) {
        return MGsOdditiesLang.GENERIC_PERCENT.translate(Math.round(ratio * 100));
    }
    ...
    public static Component getHoursMinutes(TickRateManager tickRateManager, long ticks) {
        ...
        return hours > 0 ? MGsOdditiesLang.GENERIC_HOURS_MINUTES.translate(hours, minutes % 60) : MGsOdditiesLang.GENERIC_MINUTES.translate(minutes);
    }
