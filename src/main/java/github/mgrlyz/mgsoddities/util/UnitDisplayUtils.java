...
public class UnitDisplayUtils {
    ...
    public enum EnergyUnit implements IDisableableEnum<EnergyUnit>, IEnergyConversion, Unit, IHasTranslationKey, TranslatableEnum {
        JOULES(MGsOdditiesLang.ENERGY_JOULES, MGsOdditiesLang.ENERGY_JOULES_PLURAL, MGsOdditiesLang.ENERGY_JOULES_SHORT, "j", null, ConstantPredicates.ALWAYS_TRUE) {
            @Override
        ...
        FORGE_ENERGY(MGsOdditiesLang.ENERGY_FORGE, MGsOdditiesLang.ENERGY_FORGE, MGsOdditiesLang.ENERGY_FORGE_SHORT, "fe", () -> MGsOdditiesConfig.general.forgeConversionRate,
                () -> !MGsOdditiesConfig.general.blacklistForge.getOrDefault());
        ...
        public static UnitDisplayUtils.EnergyUnit getConfigured() {
            UnitDisplayUtils.EnergyUnit type = MGsOdditiesConfig.common.energyUnit.get();
            return type.isEnabled() ? type : UnitDisplayUtils.EnergyUnit.JOULES;
        }
    }

    @NothingNullByDefault
    public enum TemperatureUnit implements IIncrementalEnum<UnitDisplayUtils.TemperatureUnit>, IHasTranslationKey, UnitDisplayUtils.Unit, TranslatableEnum {
        KELVIN(MGsOdditiesLang.TEMPERATURE_KELVIN, MGsOdditiesLang.TEMPERATURE_KELVIN_SHORT, "K", "k", 0, 1),
        CELSIUS(MGsOdditiesLang.TEMPERATURE_CELSIUS, MGsOdditiesLang.TEMPERATURE_CELSIUS_SHORT, "°C", "c", 273.15, 1),
        RANKINE(MGsOdditiesLang.TEMPERATURE_RANKINE, MGsOdditiesLang.TEMPERATURE_RANKINE_SHORT, "R", "r", 0, 1.8),
        FAHRENHEIT(MGsOdditiesLang.TEMPERATURE_FAHRENHEIT, MGsOdditiesLang.TEMPERATURE_FAHRENHEIT_SHORT, "°F", "f", 459.67, 1.8),
        AMBIENT(MGsOdditiesLang.TEMPERATURE_AMBIENT, MGsOdditiesLang.TEMPERATURE_AMBIENT_SHORT, "+STP", "stp", 300, 1);

        public static final IntFunction<UnitDisplayUtils.TemperatureUnit> BY_ID = ByIdMap.continuous(UnitDisplayUtils.TemperatureUnit::ordinal, values(), ByIdMap.OutOfBoundsStrategy.WRAP);
        public static final StreamCodec<ByteBuf, UnitDisplayUtils.TemperatureUnit> STREAM_CODEC = ByteBufCodecs.idMapper(BY_ID, UnitDisplayUtils.TemperatureUnit::ordinal);
