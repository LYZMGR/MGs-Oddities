...
public class MGsOdditiesTileEntityTypes {
    ...
    //Universal Cables
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityUniversalCable> PARAGON_UNIVERSAL_CABLE = registerCable(MGsOdditiesBlocks.PARAGON_UNIVERSAL_CABLE);
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityUniversalCable> APOTHEOSIS_UNIVERSAL_CABLE = registerCable(MGsOdditiesBlocks.APOTHEOSIS_UNIVERSAL_CABLE);
    //Mechanical Pipes
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityMechanicalPipe> PARAGON_MECHANICAL_PIPE = registerPipe(MGsOdditiesBlocks.PARAGON_MECHANICAL_PIPE);
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityMechanicalPipe> APOTHEOSIS_MECHANICAL_PIPE = registerPipe(MGsOdditiesBlocks.APOTHEOSIS_MECHANICAL_PIPE);
    //Pressurized Tubes
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityPressurizedTube> PARAGON_PRESSURIZED_TUBE = registerTube(MGsOdditiesBlocks.PARAGON_PRESSURIZED_TUBE);
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityPressurizedTube> APOTHEOSIS_PRESSURIZED_TUBE = registerTube(MGsOdditiesBlocks.APOTHEOSIS_PRESSURIZED_TUBE);
    //Logistic Transporters
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityLogisticalTransporter> PARAGON_LOGISTICAL_TRANSPORTER = registerTransporter(MGsOdditiesBlocks.PARAGON_LOGISTICAL_TRANSPORTER, MGsOdditiesTileEntityLogisticalTransporter::new);
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityLogisticalTransporter> APOTHEOSIS_LOGISTICAL_TRANSPORTER = registerTransporter(MGsOdditiesBlocks.APOTHEOSIS_LOGISTICAL_TRANSPORTER, MGsOdditiesTileEntityLogisticalTransporter::new);
    //Thermodynamic Conductors
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityThermodynamicConductor> PARAGON_THERMODYNAMIC_CONDUCTOR = registerConductor(MGsOdditiesBlocks.PARAGON_THERMODYNAMIC_CONDUCTOR);
    public static final TileEntityTypeRegistryObject<MGsOdditiesTileEntityThermodynamicConductor> APOTHEOSIS_THERMODYNAMIC_CONDUCTOR = registerConductor(MGsOdditiesBlocks.APOTHEOSIS_THERMODYNAMIC_CONDUCTOR);
    ...
    public static void register(IEventBus eventBus) {
        MGSODDITIES_TILE_ENTITY_TYPES.register(eventBus);
    }
}